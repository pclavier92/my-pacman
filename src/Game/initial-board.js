...
export const getInitialBoard = () => (
  [
    ...
    [verticalWall, dot, horizontalWall, topRightCornerWall, dot, topLeftConrnerWall, horizontalWall, topRightCornerWall, dot, topLeftConrnerWall, horizontalWall, horizontalWall, dot, horizontalWall, horizontalWall, topRightCornerWall, dot, topLeftConrnerWall, horizontalWall, topRightCornerWall, dot, topLeftConrnerWall, horizontalWall, dot, verticalWall],
    [verticalWall, dot, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, dot, dot, dot, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, dot, verticalWall],
    [verticalWall, dot, horizontalWall, bottomRightCornerWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, topLeftConrnerWall, dot, topRightCornerWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, bottomLeftCornerWAll, horizontalWall, dot, verticalWall],
    [empty, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, bigDot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, empty],
    [verticalWall, dot, horizontalWall, topRightCornerWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, bottomLeftCornerWAll, dot, bottomRightCornerWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, topLeftConrnerWall, horizontalWall, dot, verticalWall],
    [verticalWall, dot, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, dot, dot, dot, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, verticalWall, dot, dot, verticalWall],
    [verticalWall, dot, horizontalWall, bottomRightCornerWall, dot, bottomLeftCornerWAll, horizontalWall, bottomRightCornerWall, dot, bottomLeftCornerWAll, horizontalWall, horizontalWall, dot, horizontalWall, horizontalWall, bottomRightCornerWall, dot, bottomLeftCornerWAll, horizontalWall, bottomRightCornerWall, dot, bottomLeftCornerWAll, horizontalWall, dot, verticalWall],
    [verticalWall, bigDot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, dot, bigDot, verticalWall],
