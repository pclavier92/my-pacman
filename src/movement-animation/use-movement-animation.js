...
const { GAME_SPEED, ANIMATION_STEPS } = settings;
// FPS = 4 * ANIMATION_STEPS = 40 fps
// The time between steps is calculated as GAME_SPEED / ANIMATION_STEPS

const { MOVE_LEFT, MOVE_UP, MOVE_RIGHT, MOVE_DOWN } = config;

/*
 *   @size: the map is divided into a grid of glyphs of size {size}*{size} px
...
export const useMovementAnimation = (
  ...
  }, [size, lastMove, column, row, halfLenght, halfSpeed]);
  ...
  }, [left, top, step, lastMove, size, halfSpeed]);
